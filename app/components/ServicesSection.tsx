  ...
  const services = [
    {
      ...
      icon: <FaPencilRuler />,
      description:
        "تحويل الأفكار إلى مخططات قابلة للتنفيذ، مع مراعاة قوانين البناء في مصياف واستغلال المساحات بأذكى الطرق.",
    ...
    },
    {
      ...
      icon: <FaHardHat />,
      description:
        "لا داعي للقلق وملاحقة العمال. مهندسونا يشرفون على كل مرحلة لضمان عدم وجود أخطاء أو هدر في المواد.",
  ...
  return (
    <section id="services" className="py-24 bg-slate-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 text-center">
        <h2 className="text-yellow-500 font-bold tracking-wider uppercase mb-3">
          خدماتنا
        </h2>
