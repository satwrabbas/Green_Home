...
export default async function Testimonials() {
  ...
  return (
    <section id='testimonials' className="py-24 bg-gradient-to-b from-slate-950 to-slate-900 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review) => (
            <div key={review.id} className="relative bg-slate-900/50 p-8 rounded-2xl border border-white/5 hover:border-yellow-500/30 transition duration-300 group">
