...
import { FaFacebookF, FaInstagram, FaWhatsapp, FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaBuilding } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-blue-600 transition">
                <FaFacebookF />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-pink-600 transition">
                <FaInstagram />
              </a>
              <a href="https://wa.me/963900000000" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-white hover:bg-green-500 transition">
                <FaWhatsapp />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-slate-400">التصميم المعماري</li>
              <li className="text-slate-400">الدراسات الإنشائية</li>
              <li className="text-slate-400">الإكساء والديكور</li>
              <li className="text-slate-400">تعهدات البناء</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-400">
                ...
                <span dir="ltr">+963 9xx xxx xxx</span>
              </li>
              <li className="flex items-center gap-3 text-slate-400">
        ...
        <div className="border-t border-white/5 pt-8 text-center md:flex md:justify-between md:text-right">
          ...
          <p className="text-slate-600 text-sm mt-2 md:mt-0">
            تم التطوير بواسطة <span className="text-slate-400">Dev Team</span>
          </p>
        </div>
      </div>
    </footer>
