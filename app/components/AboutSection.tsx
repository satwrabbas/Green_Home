...
import { FaRulerCombined, FaHandshake, FaLightbulb, FaUserTie } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div>
              <h4 className="text-yellow-500 font-bold tracking-wider uppercase mb-2">من نحن</h4>
            ...
            <p className="text-slate-400 text-lg leading-relaxed text-justify">
              من قلب مدينة مصياف، انطلق مكتب <span className="text-white font-bold">ABCE-S</span> برؤية تهدف للارتقاء بالواقع العمراني. ندرك أن البناء في مناطقنا يتطلب فهماً خاصاً لطبيعة الأرض والمناخ، ولذوق المجتمع المحلي.
            </p>
            
            <p className="text-slate-400 text-lg leading-relaxed text-justify">
              تخصصنا لا يقتصر على صب الخرسانة؛ بل يمتد ليشمل <span className="text-yellow-500">فنون الإكساء الداخلي</span>، حيث نحول المساحات الصامتة إلى منازل تنبض بالحياة، ومكاتب تعزز الإنتاجية، مع الالتزام الصارم بالميزانية المتفق عليها.
            </p>

            {/* شبكة الميزات */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
              {features.map((item, index) => (
                <div key={index} className="flex items-start gap-4 p-4 rounded-xl bg-slate-900 border border-white/5 hover:border-yellow-500/30 transition duration-300 group">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/5]">
              ...
              {/* نص فوق الصورة في الأسفل */}
              <div className="absolute bottom-6 right-6 left-6">
                <p className="text-white font-bold text-xl">&quot;الجودة ليست صدفة، بل هي نتيجة نية عالية وجهد صادق.</p>
                <p className="text-yellow-500 mt-2 text-sm">- إدارة المكتب</p>
              </div>
            </div>

            {/* عنصر عائم (Floating Badge) */}
            <div className="absolute -bottom-10 -left-10 z-20 bg-slate-800 p-6 rounded-2xl shadow-xl border border-white/10 hidden md:block">
              <div className="flex items-center gap-4">
                ...
                <div className="text-slate-300 text-sm">
                  مشروع سكني<br />تم تسليمه
                </div>
              </div>
            </div>

            {/* زخرفة خلفية (Dot Pattern) */}
